    ...
    >
      ...
      >
        ...
        <input
          ...
          className="mt-4 w-full rounded border border-hud-green/30 bg-black/40 px-3 py-2 font-mono text-base text-hud-green outline-hidden focus:border-hud-green/70"
        />
