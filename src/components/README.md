...
- **The four god-files** — `GameCanvas` 338 (partially split 2026-05-29), `ShopUI` 408, `QuestPanel` 387, `WeaponCard` 210. Remaining splits are scheduled as follow-up PRs after Phase 4b. **Don't split inside an unrelated PR** — each is a focused refactor in itself.
